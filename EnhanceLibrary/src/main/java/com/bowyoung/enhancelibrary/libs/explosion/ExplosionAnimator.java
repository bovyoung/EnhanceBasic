package com.bowyoung.enhancelibrary.libs.explosion;
...
public class ExplosionAnimator extends ValueAnimator {
    ...
    private static final float X = DisplayUtils.dp2px(5);
    private static final float Y = DisplayUtils.dp2px(20);
    private static final float V = DisplayUtils.dp2px(2);
    private static final float W = DisplayUtils.dp2px(1);
