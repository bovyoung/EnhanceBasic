...
public class NetworkUtils {
    ...
    public static String getPublicIP(Context context) {
        ...
        LogUtils.i(TAG, "BSSID: " + wifiInfo.getBSSID() + ",IpAddress: " + wifiInfo.getIpAddress()
                + ",MacAddress: " + wifiInfo.getMacAddress() + ",SSID: " + wifiInfo.getSSID()
                + ",HiddenSSID: " + wifiInfo.getHiddenSSID() + ",LinkSpeed: " + wifiInfo.getLinkSpeed()
                + ",NetworkId: " + wifiInfo.getNetworkId() + ",Rssi: " + wifiInfo.getRssi());
